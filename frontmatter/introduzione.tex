...
% --- Contesto generale ---
La trasformazione digitale della Pubblica Amministrazione rappresenta una delle sfide strategiche più rilevanti nel panorama europeo e italiano.

% --- Significato del sottotitolo ---
Il presente lavoro è identificato con l'acronimo \textbf{JANUS-OP}, che prende ispirazione dalla divinità romana Giano (\textit{Ianus}), tradizionalmente raffigurata con due volti rivolti in direzioni opposte, simbolo della capacità di osservare simultaneamente passato e futuro per supportare decisioni strategiche consapevoli. Analogamente, un sistema di Intelligenza Artificiale on-premise (\textit{OP}) al servizio della Pubblica Amministrazione deve saper analizzare i dati storici e, al contempo, orientare le scelte verso scenari futuri, coniugando memoria istituzionale e capacità predittiva. L'adozione di tecnologie basate sull'Intelligenza Artificiale (IA) si inserisce in questo processo come leva fondamentale per il miglioramento dell'efficienza, della qualità dei servizi e della capacità decisionale delle organizzazioni pubbliche.
